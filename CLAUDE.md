...
- **✅ DMARC AJOUTÉ le 5 août 2026** (il manquait ; DKIM et SPF étaient déjà là). `TXT _dmarc.monacout.com` = `v=DMARC1; p=none; rua=mailto:contact@monacout.com` (rec_d6469cfcc0c1af0e30d8c04e). **`p=none` n'bloque rien** : il déclare la politique et demande des rapports, ce que Gmail, Yahoo et iCloud regardent en premier depuis 2024. Les rapports arrivent en XML sur `contact@` → jetayre@gmail.com ; si c'est trop bruyant, retirer la partie `rua=`.

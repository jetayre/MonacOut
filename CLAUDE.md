...
- **DNS : DMARC ABSENT sur monacout.com** (DKIM ✅, SPF ✅ sur `send.monacout.com`). À ajouter chez Vercel : `TXT _dmarc` = `v=DMARC1; p=none; rua=mailto:contact@monacout.com`. `p=none` n'bloque rien, il observe.

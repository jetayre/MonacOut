...
const GENERIQUES_SOIR = [
  ...
  "APERO FRENK FONTVIEILLE",
  "APERO BISTRO COE LARVOTTO",
  "DINER AMICI MIEI FONTVIEILLE",
  "LE RELAIS DE VENISE LA CONDAMINE",
  "APERO MALIZIA MAR QUAI ANTOINE IER",
  "OLD WILD WEST PORT HERCULE",
];

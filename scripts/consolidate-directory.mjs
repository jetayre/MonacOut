...
const cards = [
  ...
  `  {id:2050,cat:"CINÉMA",date:"${today}",time:"Tous les jours",title:"CINÉMA${NL}À MONACO",subtitle:"Salles & plein air · tous les jours",desc:"Le cinéma à Monaco, tous les jours. Touchez pour accéder au programme et aux horaires.",descEn:"Cinema in Monaco, every day. Tap for the programme and showtimes.",free:false,hot:false,fallback:"linear-gradient(150deg,#2A1A3A,#4A2A5A,#1A0A2A)",accent:"#C8A8E0",emoji:"🎬",source:"Cinémas de Monaco",quarter:"Monte-Carlo",ongoing:true,until:"2026-12-31",directory:[{name:"Cinéma des Beaux-Arts",link:"https://www.cinemas2monaco.com/",info:"Salle · programme du jour"},{name:"Monaco Open Air Cinema",link:"https://www.cinemas2monaco.com/",info:"Plein air · soirées d'été"}]},`,
];
